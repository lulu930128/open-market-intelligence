...
def _extract_analysis_digest(result: dict[str, Any], policy: dict[str, Any]) -> dict[str, Any]:
    ...
    if isinstance(analysis, dict) and analysis:
        ...
        return {
            ...
            "effective_horizon": analysis.get("effective_horizon") or selected_horizon,
            ...
            "fallback_reason": analysis.get("fallback_reason") or analysis.get("horizon_fallback_reason"),
            "display": "｜".join(display_parts),
