...
def provider_contract() -> dict[str, Any]:
    return {
        ...
        "notes": [
            ...
            "Advanced resources are surfaced with explicit maturity states; empty event-driven rows do not imply provider failure.",
        ],
        "status_taxonomy": {
            "rest_cache": "REST-backed cache resource; GET reads local cache and POST refresh fetches provider data.",
            "realtime_enabled": "WebSocket-backed realtime resource with local persistence when runtime is enabled.",
            "event_driven": "Event stream resource that can be healthy while rows are empty when no market events occur.",
            "api_key_required": "Provider integration exists but needs explicit API key configuration.",
            "local_fallback": "Derived from locally stored OMI data; quality depends on upstream event coverage.",
            "provider_pending": "Contract placeholder for a future provider integration; not connected to refresh paths yet.",
        },
        "providers": {
            BITOPRO_PROVIDER: {
                ...
                "resource_status": {
                    "ticker": "realtime_enabled",
                    "order_book": "realtime_enabled",
                    "ohlcv": "rest_cache",
                    "spread": "rest_cache",
                    "fx": "rest_cache",
                },
            ...
            BINANCE_PROVIDER: {
                ...
                "resource_status": {
                    "ticker": "realtime_enabled",
                    "order_book": "realtime_enabled",
                    "ohlcv": "realtime_enabled",
                    "derivatives": "rest_cache",
                    "spread": "rest_cache",
                    "liquidation_event": "event_driven",
                    "cvd": "provider_pending",
                    "long_short_ratio": "rest_cache",
                },
            ...
            COINGLASS_PROVIDER: {
                ...
                "resource_status": {"liquidation_heatmap": "api_key_required"},
                "status": "api_key_required",
            },
            OMI_LOCAL_PROVIDER: {
                "role": "Local fallback for estimated liquidation heatmap buckets built from stored liquidation events.",
                "resources": ["liquidation_heatmap"],
                "resource_status": {"liquidation_heatmap": "local_fallback"},
            ...
            BYBIT_PROVIDER: {
                ...
                "resource_status": {
                    "long_short_ratio": "provider_pending",
                    "liquidation_event": "provider_pending",
                    "cvd": "provider_pending",
                },
