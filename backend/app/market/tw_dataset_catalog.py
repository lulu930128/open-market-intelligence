...
def _dataset(
    *,
    ...
    read: str,
    projection: str,
    health: str = "app.market.tw_dataset_health.read_taiwan_dataset_health",
    frequency: TaiwanDatasetFrequency,
...
TW_DATASET_CONTRACTS = (
    ...
    _dataset(
        ...
        tables=("market_intraday_bar",),
        read="app.market.intraday.get_market_intraday_history",
        projection="app.routers.market.get_stock_intraday_history",
        frequency=TaiwanDatasetFrequency.INTRADAY,
        expected=TaiwanExpectedStatePolicy.CURRENT_SESSION,
        eligibility="listed_instrument_and_trading_day",
        postcondition="Return persisted bounded bars without presenting a quote snapshot as a bar.",
        lineage=TaiwanDatasetLineageStatus.LINEAGE_GAP,
        convergence=TaiwanDatasetConvergenceStatus.LINEAGE_GAP,
        limitations=("LEGACY_GET_REFRESH_SIDE_EFFECT", "RAW_RECEIPT_LINEAGE_GAP"),
    ),
    _dataset(
    ...
    _dataset(
        ...
        read="app.ai.market_context.taiwan_stock.read_stock_context",
        projection="app.market.tw_market_dashboard.build_tw_dashboard_stock_detail",
        ...
        lineage_fields=_CANONICAL_LINEAGE,
        convergence=TaiwanDatasetConvergenceStatus.COMPATIBILITY,
        limitations=("AI_CONTEXT_CURRENTLY_OWNS_DIRECT_SQL_READ",),
    ),
    _dataset(
    ...
    _dataset(
        ...
        lineage=TaiwanDatasetLineageStatus.SOURCE_ONLY,
        convergence=TaiwanDatasetConvergenceStatus.COMPATIBILITY_DERIVED,
        limitations=("COMPONENT_RAW_IDS_NOT_PERSISTED",),
    ),
    _dataset(
        ...
        read="app.market.indices.get_cached_taiwan_intraday_stock_rows",
        projection="app.market.tw_market_dashboard.build_tw_market_dashboard",
        frequency=TaiwanDatasetFrequency.INTRADAY,
        expected=TaiwanExpectedStatePolicy.CURRENT_SESSION,
