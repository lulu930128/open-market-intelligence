...
DATASET_REGISTRY = DatasetRegistry(
    (
        ...
        DatasetSpec(
            ...
            schema_version="tw.market_index.intraday.v1",
            market=Market.TW,
            scope_kind="market_index",
            owner="app.market.tw_current_market_platform",
            read_operation="read_taiwan_index_intraday_series",
            ...
            postcondition="Resolve one deterministic minute series from lineage-compatible canonical current-index events without legacy minute storage.",
            repairable=False,
        ),
        DatasetSpec(
            ...
            postcondition="Persist one complete versioned directory snapshot atomically and preserve the previous latest-successful snapshot on failure.",
            repairable=True,
        ),
        DatasetSpec(
