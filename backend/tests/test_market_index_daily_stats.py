...
class MarketIndexDailyStatTests(unittest.TestCase):
    ...
    def test_twse_mis_live_breadth_counts_classified_and_unknown_quotes(self) -> None:
        ...
        self.assertIsNone(payload["limit_up_count"])
        self.assertEqual(payload["limits"]["up"]["observed_count"], 0)
        self.assertIsNone(payload["limit_down_count"])
        self.assertEqual(payload["limits"]["down"]["observed_count"], 1)
