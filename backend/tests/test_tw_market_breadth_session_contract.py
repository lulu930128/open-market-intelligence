...
class TaiwanMarketBreadthSessionContractTests(unittest.TestCase):
    ...
    def test_preopen_pz_is_indicative_and_not_formal_breadth(self) -> None:
        row = indices._classify_twse_mis_live_breadth_message(self._message())
    ...
    def test_regular_price_requires_actual_trade_and_preserves_price_time(self) -> None:
        ...
        first = indices._classify_twse_mis_live_breadth_message(
            self._message(t="09:00:00", z="101", pz="-", ts="0", v="5")
        )
        cached = indices._classify_twse_mis_live_breadth_message(
    ...
    def test_regular_z_without_positive_volume_is_not_actual_trade(self) -> None:
        row = indices._classify_twse_mis_live_breadth_message(
    ...
    def test_actual_trade_cache_does_not_cross_trade_date(self) -> None:
        indices._classify_twse_mis_live_breadth_message(
            self._message(t="09:00:00", z="101", pz="-", ts="0", v="5")
        )
        next_day = indices._classify_twse_mis_live_breadth_message(
            self._message(
                d="20260804",
                t="08:59:00",
                z="-",
    ...
    def test_reset_clears_actual_trade_state(self) -> None:
        ...
        self.assertTrue(indices._TWSE_MIS_STOCK_STATE)

        indices.reset_twse_mis_breadth_guard()

        self.assertFalse(indices._TWSE_MIS_STOCK_STATE)
