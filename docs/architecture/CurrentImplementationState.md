...
| United States market | accepted | partial | partial | partial | 2026-09-01 | `docs/exec-plans/active/us-market-realtime-daily-root-repair-20260901/`; `docs/exec-plans/active/us-backend-shared-core-convergence-20260829/`; `docs/exec-plans/active/us-index-missing-data-repair-gate-20260830/`; executable registry／manifest；targeted source validation；architecture guard | 1m canonical identity、bounded inspector與explicit audited repair／rollback、read-side corrupt-row rejection、canonical AI freshness、bounded Priority EOD、producer cadence、keyed concurrency、retry lifecycle、session-date relation、single-source truth與timeframe-independent current observation已完成Source修復；production DB cleanup、running Backend adoption、正式Live與browser Product仍待分開驗收 |
